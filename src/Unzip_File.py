...
#                         if sub_entry.is_file() and sub_entry.name.endswith(".zip"):
#                             repo_path = sub_entry.path
#                             repo_name = os.path.splitext(sub_entry.name)[0]
...
#                             # Create a folder using the name of the zip file
#                             zip_folder_path = os.path.join(extract_path, repo_name)
#                             os.makedirs(zip_folder_path, exist_ok=True)

#                             start_time = datetime.datetime.now()
#                             try:
#                                 with zipfile.ZipFile(repo_path, 'r') as zip_ref:
#                                     # Extract all contents of the zip file into the created folder
